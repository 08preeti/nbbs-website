...
//               style={{
//                 backgroundImage:
//                   "radial-gradient(#172039 0.45px, transparent 0.45px)",
...
//               {/* ======================================================
//     SCRIBBLE / CIRCUIT DESIGN
// ====================================================== */}

// {/* ======================================================
//     SCRIBBLE / CIRCUIT DESIGN (TOUCHES RIGHT BORDER)
// ====================================================== */}
// {/* ======================================================
//     SCRIBBLE / CIRCUIT DESIGN
// ====================================================== */}
// {/* ======================================================
//     SCRIBBLE / CIRCUIT DESIGN (NO BORDER)
// ====================================================== */}
// <div
//   className="
//     pointer-events-none
...
//       <main>
//         {/* ============================================================
//             HERO (Full 100vw width with overflow-hidden)
//         ============================================================ */}
//         <section
//           id="home"
//           className="
...
//           {/* ==========================================================
//               DESKTOP SCRIBBLE / CIRCUIT (TOUCHES EXACT RIGHT SCREEN BORDER)
//           ========================================================== */}
//           <div
//             className="
//               pointer-events-none
...
//                   <span className="whitespace-nowrap text-[9px] font-bold uppercase tracking-[0.24em] text-[#172039] sm:text-[10px] sm:tracking-[0.27em]">
//                     INTEGRATED BUSINESS SOLUTIONS
//                   </span>
//                   <span className="h-px w-9 bg-[#c9a86a] sm:w-12" />
//                 </div>
...
//                 {/* DESCRIPTION */}
//                 <p className="mt-7 max-w-[590px] text-[13px] leading-[1.7] text-[#34415c] sm:mt-8 sm:text-[14px] md:text-[15px]">
...
//                 {/* BUTTONS */}
//                 <div className="mt-8 flex flex-col items-start gap-3 sm:mt-9 sm:flex-row">
//                   <Link
//                     href="/#contact"
//                     className="
//                       group
...
//                 {/* STATS */}
//                 <div className="mt-10 w-full max-w-[735px] border-t border-[#c9a86a]/35 pt-5 sm:mt-12 sm:pt-6 lg:mt-14">
//                   <div className="grid grid-cols-2 sm:grid-cols-4">
//                     {stats.map(([value, label], index) => (
//                       <div
//                         key={label}
...
//                           sm:px-5
//                           lg:px-6
//                           ${index !== 0 ? "border-l border-[#c9a86a]/35" : ""}
//                         `}
//                       >
//                         <span className="font-display text-[26px] font-semibold leading-none tracking-[-0.035em] text-[#172039] sm:text-[28px] lg:text-[30px]">
//                           {value}
//                         </span>
//                         <span className="mt-2 text-[7px] font-semibold uppercase leading-[1.35] tracking-[0.1em] text-[#172039]/55 sm:text-[8px]">
//                           {label}
//                         </span>
//                       </div>
//                     ))}
...
//               {/* MOBILE SCRIBBLE */}
//               <div className="relative z-10 mt-12 flex w-full justify-center lg:hidden">
//                 <div className="w-[115%] max-w-[620px]">
//                   <HeroScribble />
//                 </div>
//               </div>
...
//           {/* BOTTOM DIVIDER */}
//           <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-px bg-[#172039]/[0.06]" />
//         </section>
...
>>>>>>> 60d5a8183c977a6f98980c5592ab756fa0d4a456
// app/page.tsx
