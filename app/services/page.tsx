  ...
  return (
    <div className="antialiased min-h-screen flex flex-col bg-[#fbf9f8] text-[#1b1c1c]">
      ...
      <main className="flex-grow">
        ...
        <section className="relative min-h-[calc(100vh-84px)] overflow-hidden bg-[#fbf9f8] border-b border-[#d8d4cf]">

          {/* Decorative chaos → clarity illustration */}
          <div className="absolute inset-0 z-0 pointer-events-none">
            <HeroScribble />
          </div>

          {/* Soft overlay to keep typography readable */}
          <div className="absolute inset-0 z-[1] pointer-events-none bg-gradient-to-r from-[#fbf9f8]/35 via-[#fbf9f8]/5 to-[#fbf9f8]/25" />

          {/* Hero content */}
          <div className="relative z-10 flex min-h-[calc(100vh-84px)] items-center justify-center px-6 md:px-10 py-24">
            ...
            <div className="w-full max-w-[1050px] text-center">
              ...
              <div className="flex items-center justify-center gap-5 mb-8">
                ...
                <span className="h-px w-14 bg-[#c9a86a]" />

                <span className="text-[10px] sm:text-[11px] md:text-[12px] font-semibold uppercase tracking-[0.3em] text-[#141a32]">
              ...
              {/* Gold divider */}
              <div className="mx-auto mt-9 mb-8 h-px w-24 bg-[#c9a86a]" />
              ...
              {/* Feature labels */}
              <div className="mt-16 md:mt-20 flex flex-wrap items-center justify-center gap-x-7 gap-y-4">
                ...
                {[
                  ...
                  >
                    <span className="text-[9px] md:text-[10px] font-semibold uppercase tracking-[0.2em] text-[#141a32]/60">
                      {item}
                    </span>

                    {index !== 3 && (
                      <span className="hidden sm:block h-4 w-px bg-[#c9a86a]/50" />
                    )}
                  </div>
                ))}
