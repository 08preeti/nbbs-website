export default function ContactSection() {
  return (
    <section id="contact" className="bg-[#fbf9f8] text-[#141a32]">
      <div className="section-y relative overflow-hidden">
        ...
        <div className="container page-x">
          <h1 className="text-display mb-8 font-display font-medium">
            Contact Us
          </h1>
            ...
            <div className="w-full">
              <a href="tel:+919145789151" className="group block py-2">
                <div className="flex items-center gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#141a32] text-[#e9c176] transition-all duration-300 group-hover:scale-105 group-hover:bg-[#e9c176] group-hover:text-[#141a32]">
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke="currentColor"
                  ...
                  <div>
                    <p className="text-eyebrow text-[#141a32]">Contact</p>
                    <p className="text-body-lg mt-1 font-semibold text-[#141a32]">
                      +91 9145789151
                    </p>
                  </div>
                </div>
              ...
              <a href="mailto:connect@nbbs.in" className="group block py-2">
                <div className="flex items-center gap-4">
                  ...
                  <div className="mb-5">
                    <p className="text-eyebrow text-[#141a32]">Email</p>
                    <p className="text-body-lg mt-1 font-semibold text-[#141a32]">
                      connect@nbbs.in
                    </p>
                  </div>
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#141a32] text-[#e9c176] transition-all duration-300 ease-out group-hover:scale-105 group-hover:bg-[#e9c176] group-hover:text-[#141a32]">
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke="currentColor"
                  ...
                  <div className="mb-5">
                    <p className="text-eyebrow text-[#141a32]">Location</p>
                    <p className="text-body-lg mt-1 font-semibold leading-7 text-[#141a32]">
                      8, 2nd Floor, Smita Apartment 2 Patil Lane, 2, College Rd,
                      opp. Magnum Hospital, Nashik, Maharashtra 422005, India
                    </p>
                  </div>
                </div>
              </a>

              <div className="mt-4 overflow-hidden rounded-xl border border-[#c6c6ce] bg-white">
                ...
                <div className="flex items-center justify-between gap-4 px-5 py-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-button shrink-0 text-[#c0923e] transition-colors hover:text-[#141a32]"
                  >
                    View Map →
                  </a>
                </div>
