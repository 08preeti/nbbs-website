  ...
  return (
    ...
    >
      ...
      <section className="bg-[#141A32] relative overflow-hidden py-20 sm:py-24 md:py-32">
        ...
        <div className="max-w-[1280px] mx-auto px-5 sm:px-8 md:px-12 lg:px-16 relative z-10">
          <div className="max-w-4xl flex flex-col items-start">
            {/* Label */}
            <div className="flex items-center gap-3 sm:gap-4 mb-5 sm:mb-7">
              <span className="w-7 sm:w-12 h-px bg-[#e9c176]" />

              <span className="text-[9px] sm:text-[10px] tracking-[0.2em] sm:tracking-[0.25em] uppercase font-bold text-white">
                Our Services
              </span>
            ...
            {/* Subheading */}
            <p
              className="mt-5 sm:mt-6 text-[30px] sm:text-[36px] md:text-[48px] leading-[1.15] font-medium text-[#e8e7f0] max-w-4xl"
              style={{
                fontFamily: "Bodoni Moda, serif",
              }}
            >
            ...
            {/* Description */}
            <p className="mt-6 sm:mt-7 text-[15px] sm:text-[17px] md:text-[18px] leading-[1.65] text-[#c0c5e5] max-w-3xl">
            ...
            {/* Buttons */}
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-7 sm:pt-8 w-full sm:w-auto">
              <Link
                href="/#contact"
                className="bg-[#ffdea5] text-[#261900] text-[11px] sm:text-[12px] leading-none rounded-xl tracking-[0.14em] sm:tracking-widest font-bold uppercase px-5 sm:px-6 py-4 hover:bg-[#e9c176] transition-colors flex items-center justify-center gap-2 group w-full sm:w-auto"
              >
          ...
          <div className="relative h-screen overflow-hidden">
            {services.map((service, index) => (
              <article
                ...
                className="service-panel absolute inset-0 w-full h-screen bg-[#EEF0F3]"
                style={{
                  zIndex: index + 1,
                }}
              >
                {/* TOP GOLD LINE */}
                <div className="absolute top-0 left-0 right-0 h-0.5 sm:h-0.75 bg-[#e9c176]" />

                {/* =================================================
                    TOP LEFT SERVICE NUMBER
                ================================================= */}
                <div className="absolute top-5 sm:top-7 md:top-8 left-5 sm:left-8 md:left-10 lg:left-16 z-20">
                  <span className="text-[8px] sm:text-[10px] tracking-[0.2em] sm:tracking-[0.25em] uppercase text-[#8a8a91]">
                    Service
                  </span>

                  <div className="mt-1.5 sm:mt-2 flex items-center gap-2 sm:gap-3">
                    <span className="text-[11px] sm:text-[13px] font-bold text-[#141A32]">
                      {service.number}
                    </span>

                    <span className="w-5 sm:w-8 h-px bg-[#e9c176]" />

                    <span className="text-[8px] sm:text-[10px] tracking-[0.15em] sm:tracking-[0.2em] uppercase font-bold text-[#141A32]">
                      {service.category}
                    </span>
                  </div>
                </div>
                ...
                {/* =================================================
                    TOP RIGHT
                ================================================= */}
                <div className="absolute top-6 sm:top-8 right-5 sm:right-8 md:right-10 lg:right-16 z-20">
                  <span className="text-[7px] sm:text-[9px] tracking-[0.15em] sm:tracking-[0.2em] uppercase text-[#8a8a91]">
                ...
                {/* =================================================
                    MAIN CONTENT
                ================================================= */}
                <div className="w-full h-full flex items-center px-5 sm:px-8 md:px-10 lg:px-16 pt-16 sm:pt-20 pb-12">
                  <div className="w-full h-full max-w-[1600px] mx-auto flex items-center">
                    <div className="grid grid-cols-1 lg:grid-cols-12 w-full gap-0 max-h-full">
                      {/* =================================================
                          LEFT COLUMN
                      ================================================= */}
                      <div className="lg:col-span-4 lg:pr-10 xl:pr-20 flex flex-col justify-center py-3 sm:py-5 lg:py-8">
                        <span className="text-[8px] sm:text-[10px] tracking-[0.2em] sm:tracking-[0.25em] uppercase font-bold text-[#b08b4d]">
                          {service.category}
                        </span>

                        <h3
                          className="mt-2 sm:mt-4 lg:mt-5 text-[36px] sm:text-[44px] md:text-[52px] lg:text-[60px] xl:text-[72px] leading-[0.98] text-[#141A32]"
                          style={{
                            fontFamily: "Bodoni Moda, serif",
                          }}
                        >
                        ...
                        <p className="mt-3 sm:mt-5 lg:mt-7 text-[15px] sm:text-[17px] md:text-[19px] lg:text-[22px] leading-[1.4] lg:leading-normal font-medium text-[#252a3e] max-w-xl">
                          {service.subtitle}
                        </p>

                        <div className="mt-4 sm:mt-6 lg:mt-8 flex items-center gap-2 sm:gap-3">
                          <span className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-[#e9c176]" />

                          <span className="text-[8px] sm:text-[10px] tracking-[0.15em] sm:tracking-[0.18em] uppercase text-[#777780]">
                            Business Solution
                          </span>
                        </div>
                        ...
                        <Link
                          href="/#contact"
                          className="mt-5 sm:mt-7 lg:mt-10 inline-flex items-center justify-center gap-2 sm:gap-3 w-full sm:w-fit px-5 sm:px-6 py-3.5 sm:py-4 rounded-xl bg-[#141A32] text-white text-[9px] sm:text-[10px] tracking-[0.15em] sm:tracking-[0.18em] uppercase font-bold hover:bg-[#1d2642] transition-all group"
                        >
                          Book a Diagnostic

                          <span className="material-symbols-outlined text-[15px] sm:text-[17px] group-hover:translate-x-1 transition-transform">
                            arrow_forward
                          </span>
                        </Link>
                      </div>
                      ...
                      {/* =================================================
                          MIDDLE COLUMN
                      ================================================= */}
                      <div className="lg:col-span-4 lg:border-l lg:border-r border-[#c6c6ce] px-0 lg:px-8 xl:px-14 flex flex-col justify-center py-3 sm:py-5 lg:py-8 mt-3 sm:mt-4 lg:mt-0">
                        <span className="text-[8px] sm:text-[10px] tracking-[0.18em] sm:tracking-[0.22em] uppercase font-bold text-[#b08b4d]">
                          The Business Problem
                        </span>

                        <p className="mt-3 sm:mt-5 lg:mt-6 text-[13px] sm:text-[15px] md:text-[16px] lg:text-[18px] leading-[1.55] sm:leading-[1.7] lg:leading-[1.75] text-[#62626a]">
                          {service.problem}
                        </p>

                        <div className="w-10 sm:w-16 h-px bg-[#e9c176] my-4 sm:my-6 lg:my-8" />

                        <span className="block text-[8px] sm:text-[10px] tracking-[0.18em] sm:tracking-[0.22em] uppercase font-bold text-[#141A32] mb-3 sm:mb-4 lg:mb-6">
                          What changes
                        </span>
                        ...
                        <div className="space-y-2.5 sm:space-y-3 lg:space-y-4">
                          {service.points.map((point) => (
                            ...
                            >
                              <span className="flex shrink-0 items-center justify-center w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-[#e9c176] text-[#141A32] mt-0.5">
                                <span className="material-symbols-outlined text-[9px] sm:text-[12px]">
                                  check
                                </span>
                              </span>

                              <span className="text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px] leading-[1.4] sm:leading-normal text-[#46464d]">
                                {point}
                              </span>
                            </div>
                          ))}
                      ...
                      {/* =================================================
                          RIGHT COLUMN
                      ================================================= */}
                      <div className="lg:col-span-4 lg:pl-8 xl:pl-14 flex flex-col justify-center py-3 sm:py-5 lg:py-8 mt-3 sm:mt-4 lg:mt-0">
                        {/* IMAGE */}
                        <div className="relative w-full h-33.75 xs:h-[150px] sm:h-45 md:h-55 lg:h-82.5 xl:h-95 overflow-hidden bg-[#fbf9f8] border border-[#c6c6ce]">
                          <Image
                            src={service.image}
                          ...
                          <div className="absolute inset-0 bg-linear-to-t from-[#141A32]/50 via-transparent to-transparent" />

                          <div className="absolute bottom-3 sm:bottom-5 left-3 sm:left-5 right-3 sm:right-5 flex items-center justify-between">
                            <span className="px-2 sm:px-3 py-1 sm:py-1.5 bg-[#141A32] text-white text-[7px] sm:text-[8px] tracking-[0.12em] sm:tracking-[0.16em] uppercase font-bold">
                              NBBS Solution
                            </span>

                            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#e9c176] flex items-center justify-center text-[#141A32]">
                        ...
                        {/* INFORMATION */}
                        <div className="grid grid-cols-2 gap-2 sm:gap-3 lg:gap-4 mt-3 sm:mt-4 lg:mt-5">
                          {/* Perfect For */}
                          <div className="p-3 sm:p-4 lg:p-5 bg-[#fbf9f8] border border-[#c6c6ce]">
                            <span className="block text-[7px] sm:text-[8px] tracking-[0.12em] sm:tracking-[0.16em] uppercase text-[#8a8a91] font-bold">
                              Perfect For
                            </span>

                            <p className="mt-2 sm:mt-3 text-[9px] sm:text-[10px] md:text-[11px] lg:text-[12px] leading-[1.4] sm:leading-normal font-medium text-[#141A32]">
                              {service.audience}
                            </p>
                          </div>
                          ...
                          <div className="p-3 sm:p-4 lg:p-5 bg-[#fbf9f8] border border-[#c6c6ce]">
                            ...
                            <p className="mt-2 sm:mt-3 text-[9px] sm:text-[10px] md:text-[11px] lg:text-[12px] leading-[1.4] sm:leading-normal font-bold text-[#141A32]">
                              {service.proof}
                            </p>
                          </div>
                        </div>
                ...
                {/* =================================================
                    BOTTOM PROGRESS
                ================================================= */}
                <div className="absolute bottom-0 left-0 right-0 px-5 sm:px-8 md:px-10 lg:px-16 py-2.5 sm:py-3 lg:py-4 border-t border-[#c6c6ce] bg-[#EEF0F3]/95 backdrop-blur-sm flex items-center justify-between gap-4">
                  <p className="text-[7px] sm:text-[8px] lg:text-[9px] tracking-widest sm:tracking-[0.16em] uppercase text-[#777780]">
                    <span className="hidden sm:inline">Diagnose</span>

                    <span className="sm:hidden">D</span>

                    <span className="mx-1 sm:mx-2 text-[#e9c176]">
                      →
                    </span>
                  ...
                  <p className="text-[7px] sm:text-[8px] lg:text-[9px] tracking-widest sm:tracking-[0.16em] uppercase text-[#8a8a91] text-right">
